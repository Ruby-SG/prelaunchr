# -*- encoding: utf-8 -*-
# stub: inherited_resources 1.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.email = "developers@plataformatec.com.br".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<responders>.freeze, ["~> 0.6"])
      s.add_runtime_dependency(%q<has_scope>.freeze, ["~> 0.5.0"])
    else
      s.add_dependency(%q<responders>.freeze, ["~> 0.6"])
      s.add_dependency(%q<has_scope>.freeze, ["~> 0.5.0"])
    end
  else
    s.add_dependency(%q<responders>.freeze, ["~> 0.6"])
    s.add_dependency(%q<has_scope>.freeze, ["~> 0.5.0"])
